...
function PositionIndicator(component) {
  ...
  var namespaceKey = this._userKey.key(this._namespace);

  if (component._options.namespace) {
    namespaceKey = namespaceKey.key(component._options.namespace);
  }

  this._positionKey = namespaceKey.key(component._id);

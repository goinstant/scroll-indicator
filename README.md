[![Build Status](https://travis-ci.org/goinstant/scroll-indicator.png?branch=master)](https://travis-ci.org/goinstant/scroll-indicator)
...
This will open up an example of Scroll Indicator at work, using your local
build.
